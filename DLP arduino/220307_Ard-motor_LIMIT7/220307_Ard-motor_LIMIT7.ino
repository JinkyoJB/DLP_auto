...
void resinshot(int count)
{
  Serial.println(" resin shot"); Serial.print(count); Serial.println("second");
...
void resinMS(int length)//1cm -- 2000step
{
  ...
  digitalWrite(resin_DIR, LOW);  //시료 뿌리면서 우측으로 length step만큼이동
